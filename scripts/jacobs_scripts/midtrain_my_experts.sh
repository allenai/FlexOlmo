...
uv run python src/scripts/beaker/launch.py launch ai2/jupiter \
   ...
   --launch.priority=urgent -- src/scripts/train/OLMoE-2x7B-anneal-8k.py flex-2x7B-pmc-10b-8k \
   --trainer.callbacks.profiler.enabled=false \
   --dataset.mix_base_dir=/weka/oe-training-default/ai2-llm/ \
   --dataset.mix=pmc \
   ...
   --train_module.scheduler.warmup_steps=2000 \
   --train_module.optim.lr=9e-4 \
   --trainer.save_folder=/weka/oe-training-default/jacobm/flexolmo/checkpoints/flex-2x7B-pmc-10b-8k
...
uv run python src/scripts/beaker/launch.py launch ai2/jupiter \
   ...
   --launch.budget=ai2/oceo \
   --launch.workspace=ai2/olmo-instruct \
   --launch.priority=urgent -- src/scripts/train/OLMo2-7B-fixed-anneal.py flex-7b-anneal-olmo3_code-50b \
   --trainer.callbacks.profiler.enabled=false \
   --dataset.mix_base_dir=/weka/oe-training-default/ai2-llm/ \
   --dataset.mix=olmo3_code \
   --trainer.max_duration.value=50_000_000_000 \
   ...
   --train_module.scheduler.warmup_steps=2000 \
   --train_module.optim.lr=9e-4 \
   --trainer.save_folder=/weka/oe-training-default/jacobm/flexolmo/checkpoints/flex-7b-anneal-olmo3_code-50b
...
uv run python src/scripts/beaker/launch.py launch ai2/jupiter \
   ...
   --launch.budget=ai2/oceo \
   --launch.workspace=ai2/flex2 \
   --launch.priority=urgent -- src/scripts/train/OLMo2-7B-fixed-anneal.py flex-7b-try-cache-150b \
   --trainer.callbacks.profiler.enabled=false \
   --dataset.mix_base_dir=/weka/oe-training-default/ai2-llm/ \
   ...
   --trainer.save_folder=/weka/oe-training-default/jacobm/flexolmo/checkpoints/flex-7b-try-cache-150b
